...
import p17 from '@/blog/posts/2026-01-24-asyncawait-in-c-making-concurrent-code-beautiful.tsx';
import p18 from '@/blog/posts/2026-03-28-yielding-to-generators-a-pythonic-quest-for-memory-efficiency.tsx';
import p19 from '@/blog/posts/2026-03-29-mastering-typescript-generics-from-basic-constraints-to-design-patterns.tsx';
import p20 from '@/blog/posts/csharp-history-overview.tsx';
import p21 from '@/blog/posts/java-history-overview.tsx';
import p22 from '@/blog/posts/php-beginner-basics.tsx';
import p23 from '@/blog/posts/php-history-overview.tsx';
import p24 from '@/blog/posts/python-beginner-variables.tsx';
import p25 from '@/blog/posts/python-history-overview.tsx';
import p26 from '@/blog/posts/rust-history-overview.tsx';
import p27 from '@/blog/posts/typescript-beginner-types.tsx';
import p28 from '@/blog/posts/typescript-history-overview.tsx';

export const posts = [p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25, p26, p27, p28];
